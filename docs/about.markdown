...
**MICROSITE_TITLE** is a project of the [WORK_GROUP_NAME](https://thealliance.ai/focusareas/WORK_GROUP_URL_NAME){:target="wg"} work group in [The AI Alliance](https://thealliance.ai){:target="ai-alliance"}. 
