...
**Foo bar** is a project of the [FA2: Trust and Safety](https://thealliance.ai/focus-areas/trust-and-safety){:target="wg"} work group in [The AI Alliance](https://thealliance.ai){:target="ai-alliance"}. 
