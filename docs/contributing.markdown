...
We welcome your contributions to this project. Visit the project's [GitHub repo](https://github.com/The-AI-Alliance/microsite-template/){:target="repo"}, and the [open issues](https://github.com/The-AI-Alliance/microsite-template/issues){:target="repo"}, in particular, for areas where you might contribute.

# Joining the Work Group

If you are interested in participating in this project, go to the work group's [FA2: Trust and Safety](https://thealliance.ai/focus-areas/trust-and-safety){:target="ai-alliance-wg"} home page. It will have a form that you can submit to express your interest. Some pages may not have this form, but instead they may have a _subscribe to our community newsletter_ form. While we encourage you to subscribe, to tell us about your interest in this workgroup, instead use the form on the Alliance's [Become a Collaborator](https://thealliance.ai/become-a-collaborator){:target="aia-website"} page. Check the boxes that look most appropriate and describe your interest in this project in the _Message_ box.

# Making Smaller Contributions

You may not have the time or the expertise to be extensively involved, but you can easily make suggestions for small improvements. Contributing changes as [pull requests](https://github.com/The-AI-Alliance/microsite-template/pulls){:target="prs"} is the best way to contribute (and most welcome!). Alternatively, consider [posting issues](https://github.com/The-AI-Alliance/microsite-template/issues){:target="issues"}. 

For this documentation itself, the sources are in the GitHub repo's [`docs`](https://github.com/The-AI-Alliance/microsite-template/tree/main/docs){:target="repo-docs"} directory. 
...
The repo [README](https://github.com/The-AI-Alliance/microsite-template){:target="repo"} explains more details about contributing to this project.
