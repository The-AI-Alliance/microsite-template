...
* Post a [pull request](https://github.com/The-AI-Alliance/REPO_NAME_MACRO/pulls){:target="prs"}!
...
* Post a [discussion topic](https://github.com/The-AI-Alliance/REPO_NAME_MACRO/discussions){:target="discussions"}
* Post an [issue](https://github.com/The-AI-Alliance/REPO_NAME_MACRO/issues){:target="issues"}
	* See also the [project board](DASHBOARD_URL_MACRO){:target="dashboard"}
* Send us [email](mailto:contact@thealliance.ai?subject=Suggestions for MICROSITE_TITLE_MACRO). This is a general email address, so be sure to mention this particular project.
...
Want to help us drive the evolution of this project? Please join our work group or the Alliance as a whole. See the [Join Our Community](https://www.thealliance.ai/join){:target="aia-join"} page for more information about membership for individuals and organizations.

## Other Notes on Contributing

The sources for this website are in the GitHub repo's [`docs`](https://github.com/The-AI-Alliance/REPO_NAME_MACRO/tree/main/docs){:target="repo-docs"} directory.
